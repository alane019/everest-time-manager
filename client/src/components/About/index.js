          ...
          <div className="col-md-12">
            <div className="page-header">
              ...
              <h3 style={{ textAlign: "center" }}>
                ...
                setting. Furthermore, documenting those desired goals is
                essential to the likelihood of achieving your goals.
              </h3>
              <br></br>
              ...
              <br></br>
              <h3 style={{ textAlign: "center" }}>
                The Everest App is an amazingly simple and convenient tool to
                stay on-task, get more done, and enjoy the personal rewards of
